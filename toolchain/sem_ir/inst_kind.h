...
#ifndef TINYSWIFT_TOOLCHAIN_SEM_IR_INST_KIND_H_
#define TINYSWIFT_TOOLCHAIN_SEM_IR_INST_KIND_H_
...
TINYSWIFT_DEFINE_RAW_ENUM_CLASS(InstKind, uint8_t) {
#define TINYSWIFT_SEM_IR_INST_KIND(Name) TINYSWIFT_RAW_ENUM_ENUMERATOR(Name)
#include "toolchain/sem_ir/inst_kind.def"
};

class InstKind : public TINYSWIFT_ENUM_BASE(InstKind) {
 public:
#define TINYSWIFT_SEM_IR_INST_KIND(Name) TINYSWIFT_ENUM_CONSTANT_DECL(Name)
#include "toolchain/sem_ir/inst_kind.def"

  // Returns the `InstKind` for an instruction, for `TINYSWIFT_KIND_SWITCH`.
...
#define TINYSWIFT_SEM_IR_INST_KIND(Name) \
  TINYSWIFT_ENUM_CONSTANT_DEFINITION(InstKind, Name)
#include "toolchain/sem_ir/inst_kind.def"
...
#endif  // TINYSWIFT_TOOLCHAIN_SEM_IR_INST_KIND_H_
