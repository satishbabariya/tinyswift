...
TINYSWIFT_DEFINE_ENUM_CLASS_NAMES(NodeKind) {
#define TINYSWIFT_PARSE_NODE_KIND(Name) TINYSWIFT_ENUM_CLASS_NAME_STRING(Name)
...
#define TINYSWIFT_PARSE_NODE_KIND(Name) &Parse::Name::Kind,
#include "toolchain/parse/node_kind.def"
  };
  return *Table[AsInt()];
}
