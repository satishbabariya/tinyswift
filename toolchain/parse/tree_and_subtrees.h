...
#ifndef TINYSWIFT_TOOLCHAIN_PARSE_TREE_AND_SUBTREES_H_
#define TINYSWIFT_TOOLCHAIN_PARSE_TREE_AND_SUBTREES_H_
...
auto TreeAndSubtrees::ExtractNodeFromChildren(
  ...
  if (!result.has_value()) {
    ...
    TINYSWIFT_FATAL("Malformed parse node:\n{0}",
...
#endif  // TINYSWIFT_TOOLCHAIN_PARSE_TREE_AND_SUBTREES_H_
