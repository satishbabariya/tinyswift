...
#ifndef TINYSWIFT_TOOLCHAIN_PARSE_NODE_IDS_H_
#define TINYSWIFT_TOOLCHAIN_PARSE_NODE_IDS_H_
...
struct NodeIdInCategory : public NodeId {
  ...
  explicit(false) NodeIdInCategory(NodeIdForKind<Kind> node_id)
      : NodeId(node_id) {
    TINYSWIFT_CHECK(Kind.category().HasAnyOf(Category));
  }
...
#endif  // TINYSWIFT_TOOLCHAIN_PARSE_NODE_IDS_H_
