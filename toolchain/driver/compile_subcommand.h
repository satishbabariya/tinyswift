...
#ifndef TINYSWIFT_TOOLCHAIN_DRIVER_COMPILE_SUBCOMMAND_H_
#define TINYSWIFT_TOOLCHAIN_DRIVER_COMPILE_SUBCOMMAND_H_
...
#endif  // TINYSWIFT_TOOLCHAIN_DRIVER_COMPILE_SUBCOMMAND_H_
