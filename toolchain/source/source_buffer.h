...
#ifndef TINYSWIFT_TOOLCHAIN_SOURCE_SOURCE_BUFFER_H_
#define TINYSWIFT_TOOLCHAIN_SOURCE_SOURCE_BUFFER_H_
...
// A buffer of TinySwift source code.
//
// This class holds a buffer of TinySwift source code as text and makes it
// available for use in the rest of the TinySwift compiler. It owns the memory for
// the underlying source code text and ensures it lives as long as the buffer
// objects.
//
// Every buffer of source code text is notionally loaded from a TinySwift source
// file, even if provided directly when constructing the buffer. The name that
// should be used for that TinySwift source file is also retained and made
// available.
//
...
#endif  // TINYSWIFT_TOOLCHAIN_SOURCE_SOURCE_BUFFER_H_
