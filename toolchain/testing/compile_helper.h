...
#ifndef TINYSWIFT_TOOLCHAIN_TESTING_COMPILE_HELPER_H_
#define TINYSWIFT_TOOLCHAIN_TESTING_COMPILE_HELPER_H_
...
#endif  // TINYSWIFT_TOOLCHAIN_TESTING_COMPILE_HELPER_H_
