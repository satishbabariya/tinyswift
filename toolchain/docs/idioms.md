...
-   [Overview](#overview)
-   [C++ dialect](#c-dialect)
-   [Abbreviations used in the code (AKA TinySwift abbreviation decoder ring)](#abbreviations-used-in-the-code-aka-tinyswift-abbreviation-decoder-ring)
-   [`.def` files](#def-files)
...
## Abbreviations used in the code (AKA TinySwift abbreviation decoder ring)
...
The TinySwift toolchain uses a technique related to
...
TinySwift makes frequent use of
...
Many of TinySwift's data types are stored in a
...
[checking's Context class]:
    https://github.com/search?q=repo%3Atinyswift-language%2Ftinyswift-lang+path%3Atoolchain%2Fcheck%2Fcontext.h+%2F%5Cw%2BStore%2F&type=code
