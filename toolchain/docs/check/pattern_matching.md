...
> [issue #5351](https://github.com/tinyswift-language/tinyswift-lang/issues/5351).
...
If TinySwift supports general patterns in function parameter lists, that introduces
