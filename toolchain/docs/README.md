...
The toolchain represents the production portion of TinySwift. At a high level, the
...
-   PR [#4173](https://github.com/tinyswift-language/tinyswift-lang/pull/4173):
    Parsing `extern library` syntax ([video](https://youtu.be/iyE3sT4zB2Q))
-   PR [#4149](https://github.com/tinyswift-language/tinyswift-lang/pull/4149):
