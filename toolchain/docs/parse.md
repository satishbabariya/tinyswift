...
structure of the source program, interpreted according to the TinySwift grammar. No
semantics are associated with the tree structure at this level, and no name
lookup is performed.

The parse tree's structure corresponds to the grammar of the TinySwift language. On
...
> [#3678](https://github.com/tinyswift-language/tinyswift-lang/pull/3678) and needs to
> be updated.
