...
#ifndef TINYSWIFT_TOOLCHAIN_BASE_CLANG_INVOCATION_H_
#define TINYSWIFT_TOOLCHAIN_BASE_CLANG_INVOCATION_H_
...
// Converts diagnostics from the Clang driver to TinySwift diagnostics.
class ClangDriverDiagnosticConsumer : public clang::DiagnosticConsumer {
 public:
  ...
  // Generates a TinySwift warning for each Clang warning and a TinySwift error for
...
// TinySwift-compatible Clang invocation.
//
...
#endif  // TINYSWIFT_TOOLCHAIN_BASE_CLANG_INVOCATION_H_
