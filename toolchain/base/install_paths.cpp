...
static constexpr llvm::StringLiteral BazelRoot =
    "tinyswift/toolchain/install/prefix/lib/tinyswift/";

// Path within an install root for our marker of a valid install.
static constexpr llvm::StringLiteral MarkerPath = "tinyswift_install.txt";
...
auto InstallPaths::MakeForBazelRunfiles(llvm::StringRef exe_path)
  ...
  TINYSWIFT_CHECK(runfiles != nullptr, "Failed to find runtimes tree: {0}",
               runtimes_error);
