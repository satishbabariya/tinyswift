...
#ifndef TINYSWIFT_TOOLCHAIN_BASE_VALUE_STORE_TYPES_H_
#define TINYSWIFT_TOOLCHAIN_BASE_VALUE_STORE_TYPES_H_
...
#endif  // TINYSWIFT_TOOLCHAIN_BASE_VALUE_STORE_TYPES_H_
