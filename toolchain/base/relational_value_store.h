...
#ifndef TINYSWIFT_TOOLCHAIN_BASE_RELATIONAL_VALUE_STORE_H_
#define TINYSWIFT_TOOLCHAIN_BASE_RELATIONAL_VALUE_STORE_H_
...
#endif  // TINYSWIFT_TOOLCHAIN_BASE_RELATIONAL_VALUE_STORE_H_
