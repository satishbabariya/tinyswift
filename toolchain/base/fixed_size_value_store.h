...
#ifndef TINYSWIFT_TOOLCHAIN_BASE_FIXED_SIZE_VALUE_STORE_H_
#define TINYSWIFT_TOOLCHAIN_BASE_FIXED_SIZE_VALUE_STORE_H_
...
#endif  // TINYSWIFT_TOOLCHAIN_BASE_FIXED_SIZE_VALUE_STORE_H_
