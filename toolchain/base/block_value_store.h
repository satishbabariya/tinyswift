...
#ifndef TINYSWIFT_TOOLCHAIN_BASE_BLOCK_VALUE_STORE_H_
#define TINYSWIFT_TOOLCHAIN_BASE_BLOCK_VALUE_STORE_H_
...
class BlockValueStore
 ...
 public:
  ...
  explicit BlockValueStore(llvm::BumpPtrAllocator& allocator,
    ...
    TINYSWIFT_CHECK(empty_val.key() == IdT::Empty);
  }
...
#endif  // TINYSWIFT_TOOLCHAIN_BASE_BLOCK_VALUE_STORE_H_
