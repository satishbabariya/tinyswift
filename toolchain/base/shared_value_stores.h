...
#ifndef TINYSWIFT_TOOLCHAIN_BASE_SHARED_VALUE_STORES_H_
#define TINYSWIFT_TOOLCHAIN_BASE_SHARED_VALUE_STORES_H_
...
#endif  // TINYSWIFT_TOOLCHAIN_BASE_SHARED_VALUE_STORES_H_
