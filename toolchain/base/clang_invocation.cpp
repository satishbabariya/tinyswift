...
static constexpr const char IncludesFileName[] = "<tinyswift Cpp imports>";
...
auto ClangDriverDiagnosticConsumer::HandleDiagnostic(
  ...
  switch (diag_level) {
    ...
    case clang::DiagnosticsEngine::Fatal: {
      TINYSWIFT_DIAGNOSTIC(CppInteropDriverWarning, Warning, "{0}", std::string);
      TINYSWIFT_DIAGNOSTIC(CppInteropDriverError, Error, "{0}", std::string);
