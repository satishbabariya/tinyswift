...
#ifndef TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_NULL_DIAGNOSTICS_H_
#define TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_NULL_DIAGNOSTICS_H_
...
#endif  // TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_NULL_DIAGNOSTICS_H_
