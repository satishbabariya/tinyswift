...
#ifndef TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_KIND_H_
#define TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_KIND_H_
...
// long-term.
TINYSWIFT_DEFINE_RAW_ENUM_CLASS(Kind, uint16_t) {
#define TINYSWIFT_DIAGNOSTIC_KIND(Name) TINYSWIFT_RAW_ENUM_ENUMERATOR(Name)
...
class Kind : public TINYSWIFT_ENUM_BASE(Kind) {
 public:
#define TINYSWIFT_DIAGNOSTIC_KIND(Name) TINYSWIFT_ENUM_CONSTANT_DECL(Name)
#include "toolchain/diagnostics/kind.def"
};

#define TINYSWIFT_DIAGNOSTIC_KIND(Name) TINYSWIFT_ENUM_CONSTANT_DEFINITION(Kind, Name)
#include "toolchain/diagnostics/kind.def"
...
#endif  // TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_KIND_H_
