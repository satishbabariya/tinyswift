...
#ifndef TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_DIAGNOSTIC_H_
#define TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_DIAGNOSTIC_H_
...
//   TINYSWIFT_DIAGNOSTIC(MyDiagnostic, Error, "invalid code!");
//   TINYSWIFT_DIAGNOSTIC(MyDiagnostic, Warning, "found {0}, expected {1}",
...
#define TINYSWIFT_DIAGNOSTIC(DiagnosticName, LevelValue, Format, ...)         \
  static constexpr auto DiagnosticName =                                   \
      ::TinySwift::Diagnostics::DiagnosticBase<__VA_ARGS__>(                  \
          ::TinySwift::Diagnostics::Kind::DiagnosticName,                     \
          ::TinySwift::Diagnostics::Level::LevelValue, /*is_on_scope=*/false, \
          Format)

// Similar to `TINYSWIFT_DIAGNOSTIC`, but for diagnostics that are generated on a
// scope; see `Diagnostic::is_on_scope` for details.
#define TINYSWIFT_DIAGNOSTIC_ON_SCOPE(DiagnosticName, LevelValue, Format, ...) \
  static constexpr auto DiagnosticName =                                    \
      ::TinySwift::Diagnostics::DiagnosticBase<__VA_ARGS__>(                   \
          ::TinySwift::Diagnostics::Kind::DiagnosticName,                      \
          ::TinySwift::Diagnostics::Level::LevelValue, /*is_on_scope=*/true,   \
          Format)
...
#endif  // TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_DIAGNOSTIC_H_
