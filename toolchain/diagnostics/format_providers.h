...
#ifndef TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_FORMAT_PROVIDERS_H_
#define TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_FORMAT_PROVIDERS_H_
...
template <>
struct llvm::format_provider<TinySwift::Diagnostics::BoolAsSelect> {
  static auto format(const TinySwift::Diagnostics::BoolAsSelect& wrapper,
                     raw_ostream& out, StringRef style) -> void;
};

// See Diagnostics::IntAsSelect.
template <>
struct llvm::format_provider<TinySwift::Diagnostics::IntAsSelect> {
  static auto format(const TinySwift::Diagnostics::IntAsSelect& wrapper,
                     raw_ostream& out, StringRef style) -> void;
};

#endif  // TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_FORMAT_PROVIDERS_H_
