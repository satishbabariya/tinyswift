...
#ifndef TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_SORTING_CONSUMER_H_
#define TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_SORTING_CONSUMER_H_
...
class SortingConsumer : public Consumer {
 public:
  ...
  ~SortingConsumer() override {
    ...
    TINYSWIFT_CHECK(diagnostics_.empty(),
...
#endif  // TINYSWIFT_TOOLCHAIN_DIAGNOSTICS_SORTING_CONSUMER_H_
