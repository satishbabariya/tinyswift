...
using ::TinySwift::Testing::IsSingleDiagnostic;
using ::testing::_;
using ::testing::ElementsAreArray;

TINYSWIFT_DIAGNOSTIC(TestDiagnostic, Error, "Diag{0}", int);
TINYSWIFT_DIAGNOSTIC_ON_SCOPE(TestDiagnosticOnScope, Error, "DiagOnScope{0}", int);
