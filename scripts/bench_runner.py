...
- TinySwift's documentation:
  https://docs.swift-lang.dev/docs/project/contribution_tools.html#optional-tools
...
Example regex: `(?P<tag>(?P<main>TinySwift)|Abseil|LLVM)HashBench`

This produces three tags, `TinySwift`, `Abseil`, and `LLVM`. The main tag is
`TinySwift`.
