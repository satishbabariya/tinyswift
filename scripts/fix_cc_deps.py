...
def main() -> None:
    ...
    print("Querying bazel for TinySwift targets...")
    tinyswift_rules = get_rules(bazel, "//...", False)
    ...
    any_ambiguous = False
    for rule_name, rule in tinyswift_rules.items():
