...
"""Defines `cc_toolchain_config` features specific to the TinySwift project."""
...
tinyswift_project_fastbuild_feature = feature(
...
def tinyswift_project_features(cache_key):
    return [tinyswift_project_fastbuild_feature, feature(
        name = "project_flags",
        enabled = True,
        flag_sets = [
            flag_set(
