...
#ifndef TINYSWIFT_COMMON_INIT_LLVM_H_
#define TINYSWIFT_COMMON_INIT_LLVM_H_
...
// this class should be created in the `main` function of each TinySwift binary
// that interacts with LLVM, before `argc` and `argv` are first inspected.
class InitLLVM {
 public:
  // Initializes LLVM for use by a TinySwift binary. On Windows, `argc` and `argv`
...
#endif  // TINYSWIFT_COMMON_INIT_LLVM_H_
