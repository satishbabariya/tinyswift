...
#ifndef TINYSWIFT_COMMON_STRUCT_REFLECTION_H_
#define TINYSWIFT_COMMON_STRUCT_REFLECTION_H_
...
namespace TinySwift::StructReflection {
...
#endif  // TINYSWIFT_COMMON_STRUCT_REFLECTION_H_
