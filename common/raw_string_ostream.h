...
#ifndef TINYSWIFT_COMMON_RAW_STRING_OSTREAM_H_
#define TINYSWIFT_COMMON_RAW_STRING_OSTREAM_H_
...
class RawStringOstream : public llvm::raw_pwrite_stream {
 public:
  ...
  ~RawStringOstream() override {
    TINYSWIFT_CHECK(str_.empty(), "Expected to be emptied by TakeStr, have: {0}",
                 str_);
  }
...
#endif  // TINYSWIFT_COMMON_RAW_STRING_OSTREAM_H_
