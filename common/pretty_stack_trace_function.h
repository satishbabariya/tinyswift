...
#ifndef TINYSWIFT_COMMON_PRETTY_STACK_TRACE_FUNCTION_H_
#define TINYSWIFT_COMMON_PRETTY_STACK_TRACE_FUNCTION_H_
...
#endif  // TINYSWIFT_COMMON_PRETTY_STACK_TRACE_FUNCTION_H_
