...
// These are directly in the TinySwift namespace because the defines require it.
TINYSWIFT_DEFINE_RAW_ENUM_CLASS(TestKind, uint8_t) {
#define TINYSWIFT_ENUM_BASE_TEST_KIND(Name) TINYSWIFT_RAW_ENUM_ENUMERATOR(Name)
#include "common/enum_base_test.def"
};

class TestKind : public TINYSWIFT_ENUM_BASE(TestKind) {
 public:
#define TINYSWIFT_ENUM_BASE_TEST_KIND(Name) TINYSWIFT_ENUM_CONSTANT_DECL(Name)
#include "common/enum_base_test.def"
...
#define TINYSWIFT_ENUM_BASE_TEST_KIND(Name) \
  TINYSWIFT_ENUM_CONSTANT_DEFINITION(TestKind, Name)
#include "common/enum_base_test.def"

TINYSWIFT_DEFINE_ENUM_CLASS_NAMES(TestKind) {
#define TINYSWIFT_ENUM_BASE_TEST_KIND(Name) TINYSWIFT_ENUM_CLASS_NAME_STRING(Name)
#include "common/enum_base_test.def"
};
