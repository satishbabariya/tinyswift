...
#ifndef TINYSWIFT_COMMON_STRING_HELPERS_H_
#define TINYSWIFT_COMMON_STRING_HELPERS_H_
...
// Unescapes TinySwift escape sequences in the source string. Returns std::nullopt
...
#endif  // TINYSWIFT_COMMON_STRING_HELPERS_H_
