...
#ifndef TINYSWIFT_COMMON_SET_H_
#define TINYSWIFT_COMMON_SET_H_
...
// stateless and will hash using `TinySwift::HashValue` and compare using
  ...
  requires std::invocable<InsertCallbackT, LookupKeyT, void*>
{
  ...
  TINYSWIFT_DCHECK(entry, "Should always result in a valid index.");
