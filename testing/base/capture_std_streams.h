...
#ifndef TINYSWIFT_TESTING_BASE_CAPTURE_STD_STREAMS_H_
#define TINYSWIFT_TESTING_BASE_CAPTURE_STD_STREAMS_H_
...
#endif  // TINYSWIFT_TESTING_BASE_CAPTURE_STD_STREAMS_H_
