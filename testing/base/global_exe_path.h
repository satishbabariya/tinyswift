...
#ifndef TINYSWIFT_TESTING_BASE_GLOBAL_EXE_PATH_H_
#define TINYSWIFT_TESTING_BASE_GLOBAL_EXE_PATH_H_

#include "llvm/ADT/StringRef.h"

// When using the TinySwift `main` function for GoogleTest, we export some extra
...
#endif  // TINYSWIFT_TESTING_BASE_GLOBAL_EXE_PATH_H_
