...
#ifndef TINYSWIFT_TESTING_FILE_TEST_FILE_TEST_BASE_H_
#define TINYSWIFT_TESTING_FILE_TEST_FILE_TEST_BASE_H_
...
//
// The `TINYSWIFT_FILE_TEST_FACTOR` macro below provides a standard, convenient way
// to implement this function.
extern auto GetFileTestFactory() -> FileTestFactory;

// Provides a standard GetFileTestFactory implementation.
#define TINYSWIFT_FILE_TEST_FACTORY(Name)                                       \
...
#endif  // TINYSWIFT_TESTING_FILE_TEST_FILE_TEST_BASE_H_
