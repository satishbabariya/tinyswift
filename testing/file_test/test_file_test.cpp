...
// be a definition of TinySwiftFileTestManifest (normally generated by a file_test
...
const char* TinySwiftFileTestManifest[] = {nullptr};
...
class DummyFileTest : public FileTestBase {
 public:
  ...
  auto Run(const llvm::SmallVector<llvm::StringRef>& /*test_args*/,
    ...
    TINYSWIFT_FATAL("Called method of dummy object");
  }
...
TINYSWIFT_FILE_TEST_FACTORY(DummyFileTest)
